/**
 * Zadanie 7. Obsługa sygnałów
 * Napisz program, który prosi o podanie hasła i kończy działanie,
 * jeśli użytkownik nie wprowadzi hasła w określonym czasie.
 * Wskazówka: użyj funkcji alarm().
 */
#include <stdio.h>
#include <signal.h>
#include <string.h>
